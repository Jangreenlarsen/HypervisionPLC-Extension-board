...
#define CONFIG_SCHEMA_VERSION   29      // Current config schema version (schema 29-feltet er reserveret/ubrugt — FEAT-408 rullet tilbage, se BUGS_INDEX.md)
...
#define PROJECT_VERSION     "7.9.57.0"
